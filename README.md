...
- 🔭 I worked for [Amazon Web Services (AWS - CH)](https://www.linkedin.com/in/ddurand/) in [AWS Mainframe Modernization service](https://aws.amazon.com/mainframe-modernization/) team, contributing to the design and development of various features and integrations. I focused on leveraging GenAI ([Amazon Bedrock](https://aws.amazon.com/bedrock/), [Amazon Q](https://aws.amazon.com/q/), etc.) to accelerate mainframe migrations to the AWS Cloud via automated documentation, code & test generation. 
